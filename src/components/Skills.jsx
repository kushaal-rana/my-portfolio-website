...
const Skills = () => {
  ...
  // Function to handle mouse hover and card tilting effect
    ...
    >
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full lg:pt-48">
        ...
        <div className="flex flex-col relative items-center lg:items-start">
          <h2 className="text-4xl lg:text-4xl font-semibold inline mb-14 before:content-experience before:absolute before:opacity-100 before:-top-[2rem] before:hidden before:lg:block lg:ml-52 text-slate-300">
            <span className="block border-b-4 border-gray-500 text-5xl lg:border-none lg:inline">
              Skills
            </span>
          </h2>
        </div>
        ...
        <div className="flex flex-wrap justify-center mt-8 gap-6 w-full">
          {skills.map((skill, index) => (
            <div
              key={skill.title}
              id={`card-${index}`}
              className="w-full max-w-lg bg-gray-800 shadow-md border border-purple-500 rounded-xl p-8 transition-transform duration-300 md:max-w-md sm:max-w-sm hover:shadow-[0_0_20px_8px_rgba(133,76,230,0.6)] hover:border-purple-400"
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {skill.skills.map((item) => (
                  <div
                    key={item.name}
                    className="flex items-center justify-center gap-2 text-sm font-medium text-gray-300 bg-gray-700 border border-gray-500 rounded-full p-2 px-4 hover:bg-gray-600 transition-all duration-200"
                  >
